...
const GOOGLE_SCRIPT_URL =
  "https://script.google.com/macros/s/AKfycbxj__Z1-G3tUgWctsiR6dwkqCEeAIEwj7PZ520BPZHQQ5HCi5sCBgyF_8opE-b51IsOUg/exec";
const inputClasses =
    ...
    <div className="relative min-h-screen w-full flex flex-col items-center justify-start pt-44 overflow-hidden">
      ...
      >
        ...
        <div className="absolute inset-0 flex flex-col items-center justify-start pt-12 z-20 pointer-events-none gap-4 px-6">
          {/* Main tagline */}
          <div
            className={isMobile ? "" : "float-container"}
          ...
          >
            <motion.p
              ...
              style={{
                textShadow:
                  "0 0 20px rgba(100, 160, 255, 0.9), 0 0 50px rgba(100, 160, 255, 0.5)",
              }}
            >
          ...
          <div
            className={`${isMobile ? "" : "float-container"} pointer-events-auto`}
              ...
              <div className="p-6 md:p-8 pt-7">
                ...
                {!submitted ? (
                  ...
                  >
                    ...
                    <p className="text-white/80 text-lg tracking-[0.15em] font-thin">
                      Application Sent!
                    </p>
