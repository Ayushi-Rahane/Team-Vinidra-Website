  ...
  useEffect(() => {
    ...
    class MouseClass {
      constructor() {
        ...
        this.lerpSpeed = 0.85; // Faster response, lower latency
      ...
      update() {
        if (this.takeoverActive) {
          ...
          // Smooth lerp towards target for fluid, lag-free tracking
          this.coords.lerp(this.targetCoords, this.lerpSpeed);
        }
