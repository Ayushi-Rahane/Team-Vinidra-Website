    ...
    <div className="min-h-screen relative z-10 flex flex-col justify-center px-[5%] pt-24 pb-12">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-[1200px] mx-auto">
        <div className="bg-[rgba(15,20,45,0.6)] backdrop-blur-md border border-white/10 rounded-2xl p-8 shadow-[0_8px_32px_rgba(0,0,0,0.5)] transition-all duration-300 hover:-translate-y-1 hover:shadow-[0_10px_40px_rgba(74,144,226,0.2)] hover:border-[#4a90e2]/50">
          <h3 className="font-[family-name:--font-subheading] text-[#4a90e2] text-2xl mb-4 flex items-center gap-2">📖 Team Story</h3>
        ...
        <div className="bg-[rgba(15,20,45,0.6)] backdrop-blur-md border border-white/10 rounded-2xl p-8 shadow-[0_8px_32px_rgba(0,0,0,0.5)] transition-all duration-300 hover:-translate-y-1 hover:shadow-[0_10px_40px_rgba(74,144,226,0.2)] hover:border-[#4a90e2]/50">
          <h3 className="font-[family-name:--font-subheading] text-[#4a90e2] text-2xl mb-4 flex items-center gap-2">🚀 Mission</h3>
        ...
        <div className="bg-[rgba(15,20,45,0.6)] backdrop-blur-md border border-white/10 rounded-2xl p-8 shadow-[0_8px_32px_rgba(0,0,0,0.5)] transition-all duration-300 hover:-translate-y-1 hover:shadow-[0_10px_40px_rgba(74,144,226,0.2)] hover:border-[#4a90e2]/50">
          <h3 className="font-[family-name:--font-subheading] text-[#4a90e2] text-2xl mb-4 flex items-center gap-2">🌠 Flagship Project</h3>
        ...
        <div className="bg-[rgba(15,20,45,0.6)] backdrop-blur-md border border-white/10 rounded-2xl p-8 shadow-[0_8px_32px_rgba(0,0,0,0.5)] transition-all duration-300 hover:-translate-y-1 hover:shadow-[0_10px_40px_rgba(74,144,226,0.2)] hover:border-[#4a90e2]/50">
          <h3 className="font-[family-name:--font-subheading] text-[#4a90e2] text-2xl mb-4 flex items-center gap-2">👩‍🏫 Leadership</h3>
