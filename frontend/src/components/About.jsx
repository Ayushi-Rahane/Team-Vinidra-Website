      ...
      >
        ...
        >
          ...
          <div className="relative">
            ...
            <p className="text-white/80 leading-relaxed text-[15px]">
              The team actively works on satellite development, rocket
              engineering projects, aerospace competitions and technical
              workshops that help members build strong engineering and
