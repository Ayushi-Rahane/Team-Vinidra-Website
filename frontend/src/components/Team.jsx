    ...
    <section className="relative min-h-screen flex flex-col items-center justify-center px-4 py-24 overflow-hidden">
      ...
      >
        ...
        <div className="absolute inset-0 flex items-center justify-center gap-[12px]">
          <div className="w-[115px] text-center overflow-hidden rounded-2xl border border-white/15
            bg-gradient-to-bl from-sky-400/15 via-white/5 to-transparent
            backdrop-blur-md px-3 py-4 shadow-xl flex flex-col items-center aspect-[4/5] justify-center">
            <div className="w-10 h-10 rounded-full border border-sky-300/50 bg-sky-900/20 flex items-center justify-center flex-shrink-0 mb-2">
              <Users className="w-4 h-4 text-sky-300" />
            </div>
            <p className="text-white text-[10px] tracking-[0.15em] uppercase leading-tight mt-1 mb-1.5 font-medium">Arshia<br/>Singh</p>
            <p className="text-sky-300/70 text-[7px] tracking-wider uppercase">Project Manager</p>
          </div>
          <div className="w-[115px] text-center overflow-hidden rounded-2xl border border-white/15
            bg-gradient-to-bl from-sky-400/15 via-white/5 to-transparent
            backdrop-blur-md px-3 py-4 shadow-xl flex flex-col items-center aspect-[4/5] justify-center">
            ...
            <p className="text-white text-[10px] tracking-[0.15em] uppercase leading-tight mt-1 mb-1.5 font-medium">Nandini<br/>Pathak</p>
            <p className="text-sky-300/70 text-[7px] tracking-wider uppercase">Project Manager</p>
          </div>
        </div>
      </motion.div>
