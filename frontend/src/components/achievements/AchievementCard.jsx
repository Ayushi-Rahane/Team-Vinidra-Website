...
//             backdrop-blur-xl rounded-3xl border ${category.border}
//             transition duration-500
//             hover:shadow-[0_20px_80px_rgba(0,0,0,0.7)] cursor-pointer`}
//         >
...
//             className="w-full h-48 object-cover rounded-2xl mb-5 group-hover:scale-105 transition-transform duration-500"
//           />
...
//             {/* Category Badge */}
//             <span className="inline-block mt-3 px-4 py-1.5 text-xs rounded-full bg-white/10 text-white/80 border border-white/10 tracking-wide capitalize">
//               {achievement.category}
//             </span>

//             {/* See More Button */}
//             <button
//               onClick={() => navigate(achievement.detailsPage)}
//               className="mt-5 self-start bg-blue-500 hover:bg-blue-600 text-white px-4 py-2 rounded-xl font-semibold transition"
//             >
//               See More
//             </button>
//           </div>
